...
matlabbatch{12}.spm.tools.mantis.neonatetemplate = struct([]);
matlabbatch{13}.spm.tools.mantis.defs.def(1) = cfg_dep;
matlabbatch{13}.spm.tools.mantis.defs.def(1).tname = 'Deformation Field';
matlabbatch{13}.spm.tools.mantis.defs.def(1).tgt_spec{1}(1).name = 'class';
matlabbatch{13}.spm.tools.mantis.defs.def(1).tgt_spec{1}(1).value = 'cfg_files';
matlabbatch{13}.spm.tools.mantis.defs.def(1).tgt_spec{1}(2).name = 'strtype';
matlabbatch{13}.spm.tools.mantis.defs.def(1).tgt_spec{1}(2).value = 'e';
matlabbatch{13}.spm.tools.mantis.defs.def(1).sname = 'Move/Delete Files: Moved/Copied Files';
matlabbatch{13}.spm.tools.mantis.defs.def(1).src_exbranch = substruct('.','val', '{}',{9}, '.','val', '{}',{1});
matlabbatch{13}.spm.tools.mantis.defs.def(1).src_output = substruct('.','files');
matlabbatch{13}.spm.tools.mantis.defs.fnames(1) = cfg_dep;
matlabbatch{13}.spm.tools.mantis.defs.fnames(1).tname = 'Apply to';
matlabbatch{13}.spm.tools.mantis.defs.fnames(1).tgt_spec{1}(1).name = 'filter';
matlabbatch{13}.spm.tools.mantis.defs.fnames(1).tgt_spec{1}(1).value = 'image';
matlabbatch{13}.spm.tools.mantis.defs.fnames(1).tgt_spec{1}(2).name = 'strtype';
matlabbatch{13}.spm.tools.mantis.defs.fnames(1).tgt_spec{1}(2).value = 'e';
matlabbatch{13}.spm.tools.mantis.defs.fnames(1).sname = 'Path for all components of the neonate template: Neonate template';
matlabbatch{13}.spm.tools.mantis.defs.fnames(1).src_exbranch = substruct('.','val', '{}',{12}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{13}.spm.tools.mantis.defs.fnames(1).src_output = substruct('.','tissuemap', '()',{':'});
matlabbatch{13}.spm.tools.mantis.defs.saveusr(1) = cfg_dep;
matlabbatch{13}.spm.tools.mantis.defs.saveusr(1).tname = 'Output directory';
matlabbatch{13}.spm.tools.mantis.defs.saveusr(1).tgt_spec{1}(1).name = 'filter';
matlabbatch{13}.spm.tools.mantis.defs.saveusr(1).tgt_spec{1}(1).value = 'dir';
matlabbatch{13}.spm.tools.mantis.defs.saveusr(1).tgt_spec{1}(2).name = 'strtype';
matlabbatch{13}.spm.tools.mantis.defs.saveusr(1).tgt_spec{1}(2).value = 'e';
matlabbatch{13}.spm.tools.mantis.defs.saveusr(1).sname = 'Folders for phases - image files get placed here: Phase2 subfolder';
matlabbatch{13}.spm.tools.mantis.defs.saveusr(1).src_exbranch = substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{13}.spm.tools.mantis.defs.saveusr(1).src_output = substruct('.','outpathphase2', '()',{':'});
matlabbatch{13}.spm.tools.mantis.defs.interp = 1;
