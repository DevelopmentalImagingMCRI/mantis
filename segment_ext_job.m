...
matlabbatch{1}.spm.tools.preproc8.tissue(1).tpm = {fullfile(spm('dir'),'toolbox','ANBS', 'template','cortex.nii,1')};
matlabbatch{1}.spm.tools.preproc8.tissue(1).ngaus = 2;
matlabbatch{1}.spm.tools.preproc8.tissue(1).native = [1 0];
matlabbatch{1}.spm.tools.preproc8.tissue(1).warped = [0 0];
matlabbatch{1}.spm.tools.preproc8.tissue(2).tpm = {fullfile(spm('dir'),'toolbox','ANBS', 'template','wm.nii,1')};
matlabbatch{1}.spm.tools.preproc8.tissue(2).ngaus = 2;
matlabbatch{1}.spm.tools.preproc8.tissue(2).native = [1 0];
matlabbatch{1}.spm.tools.preproc8.tissue(2).warped = [0 0];
matlabbatch{1}.spm.tools.preproc8.tissue(3).tpm = {fullfile(spm('dir'),'toolbox','ANBS', 'template','csf.nii,1')};
matlabbatch{1}.spm.tools.preproc8.tissue(3).ngaus = 2;
matlabbatch{1}.spm.tools.preproc8.tissue(3).native = [1 0];
matlabbatch{1}.spm.tools.preproc8.tissue(3).warped = [0 0];
matlabbatch{1}.spm.tools.preproc8.tissue(4).tpm = {fullfile(spm('dir'),'toolbox','ANBS', 'template','deepgreymatter_map.nii,1')};
...
matlabbatch{1}.spm.tools.preproc8.tissue(5).tpm = {fullfile(spm('dir'),'toolbox','ANBS', 'template','hippocampus_map.nii,1')};
...
matlabbatch{1}.spm.tools.preproc8.tissue(6).tpm = {fullfile(spm('dir'),'toolbox','ANBS', 'template','amygdala_map.nii,1')};
matlabbatch{1}.spm.tools.preproc8.tissue(6).ngaus = 2;
matlabbatch{1}.spm.tools.preproc8.tissue(6).native = [1 0];
matlabbatch{1}.spm.tools.preproc8.tissue(6).warped = [0 0];
matlabbatch{1}.spm.tools.preproc8.tissue(7).tpm = {fullfile(spm('dir'),'toolbox','ANBS', 'template','cerebellum.nii,1')};
...
matlabbatch{1}.spm.tools.preproc8.tissue(8).tpm = {fullfile(spm('dir'),'toolbox','ANBS', 'template','brainstem.nii,1')};
...
matlabbatch{1}.spm.tools.preproc8.tissue(9).tpm = {fullfile(spm('dir'),'toolbox','ANBS', 'template','background.nii,1')};
